...
type ReportChangeLogsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	SpiffeId string             `protobuf:"bytes,1,opt,name=spiffe_id,json=spiffeId,proto3" json:"spiffe_id,omitempty"`
	Images   []*ImageChangeLogs `protobuf:"bytes,2,rep,name=images,proto3" json:"images,omitempty"`
}

func (x *ReportChangeLogsRequest) Reset() {
	*x = ReportChangeLogsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReportChangeLogsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReportChangeLogsRequest) ProtoMessage() {}

func (x *ReportChangeLogsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_machine_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReportChangeLogsRequest.ProtoReflect.Descriptor instead.
func (*ReportChangeLogsRequest) Descriptor() ([]byte, []int) {
	return file_machine_proto_rawDescGZIP(), []int{15}
}

func (x *ReportChangeLogsRequest) GetSpiffeId() string {
	if x != nil {
		return x.SpiffeId
	}
	return ""
...
func (x *ReportChangeLogsRequest) GetImages() []*ImageChangeLogs {
	if x != nil {
		return x.Images
	}
	return nil
...
type ImageChangeLogs struct {
	...
	// These are the digests in the manifest describing the layers of the image.
	LayerDigests    []string     `protobuf:"bytes,3,rep,name=layer_digests,json=layerDigests,proto3" json:"layer_digests,omitempty"`
	LayerChangelogs []*Changelog `protobuf:"bytes,4,rep,name=layer_changelogs,json=layerChangelogs,proto3" json:"layer_changelogs,omitempty"`
}

func (x *ImageChangeLogs) Reset() {
	*x = ImageChangeLogs{}
	if protoimpl.UnsafeEnabled {
...
func (x *ImageChangeLogs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ImageChangeLogs) ProtoMessage() {}

func (x *ImageChangeLogs) ProtoReflect() protoreflect.Message {
	mi := &file_machine_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ImageChangeLogs.ProtoReflect.Descriptor instead.
func (*ImageChangeLogs) Descriptor() ([]byte, []int) {
	return file_machine_proto_rawDescGZIP(), []int{16}
}

func (x *ImageChangeLogs) GetImageName() string {
	if x != nil {
		return x.ImageName
	}
	return ""
...
func (x *ImageChangeLogs) GetPlatform() string {
	if x != nil {
		return x.Platform
	}
	return ""
...
func (x *ImageChangeLogs) GetLayerDigests() []string {
	if x != nil {
...
func (x *ImageChangeLogs) GetLayerChangelogs() []*Changelog {
	if x != nil {
		return x.LayerChangelogs
	}
	return nil
}
...
type Changelog struct {
	...
	// This is buildkit cacheID.
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// Stable digest of the snapshot that created this image layer.
	StableDigest string `protobuf:"bytes,2,opt,name=stable_digest,json=stableDigest,proto3" json:"stable_digest,omitempty"`
	// Creator digest is the digest of the snapshot that created this image layer.
	CreatorDigest string `protobuf:"bytes,3,opt,name=creator_digest,json=creatorDigest,proto3" json:"creator_digest,omitempty"`
	// number of files in the image layer.
	...
	// 2: modified
	// 3: deleted
	Changes []uint32 `protobuf:"varint,5,rep,packed,name=changes,proto3" json:"changes,omitempty"`
	// len(sizes) == num;
	// sizes are in bytes.
	Sizes []int64 `protobuf:"varint,6,rep,packed,name=sizes,proto3" json:"sizes,omitempty"`
	// len(modes) == num;
	// https://pkg.go.dev/io/fs#FileMode
	Modes []uint32 `protobuf:"varint,7,rep,packed,name=modes,proto3" json:"modes,omitempty"`
	// len(paths) == num;
	// absolute paths of files in the image layer.
...
func (x *Changelog) GetStableDigest() string {
	if x != nil {
...
func (x *Changelog) GetCreatorDigest() string {
	if x != nil {
		return x.CreatorDigest
	}
	return ""
}

func (x *Changelog) GetNum() uint32 {
	if x != nil {
		return x.Num
	}
	return 0
...
func (x *Changelog) GetChanges() []uint32 {
	if x != nil {
		return x.Changes
	}
	return nil
...
func (x *Changelog) GetSizes() []int64 {
	if x != nil {
		return x.Sizes
	}
	return nil
...
func (x *Changelog) GetModes() []uint32 {
	if x != nil {
		return x.Modes
	}
	return nil
...
func (x *Changelog) GetPaths() []string {
	if x != nil {
		return x.Paths
	}
	return nil
...
type ReportChangeLogsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ReportChangeLogsResponse) Reset() {
	*x = ReportChangeLogsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReportChangeLogsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReportChangeLogsResponse) ProtoMessage() {}

func (x *ReportChangeLogsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_machine_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReportChangeLogsResponse.ProtoReflect.Descriptor instead.
func (*ReportChangeLogsResponse) Descriptor() ([]byte, []int) {
...
var file_machine_proto_rawDesc = []byte{
	...
	0x64, 0x22, 0xc6, 0x0d, 0x0a, 0x17, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x4d, 0x61,
	...
	0x0d, 0x0a, 0x0b, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x54, 0x61, 0x73, 0x6b, 0x1a, 0xb4,
	0x06, 0x0a, 0x0c, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x4b, 0x69, 0x74, 0x54, 0x61, 0x73, 0x6b, 0x12,
	...
	,
	...
	0x49, 0x64, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x61, 0x73, 0x6b, 0x22, 0x6a, 0x0a, 0x18, 0x50, 0x69,
	...
	0x69, 0x6e, 0x65, 0x49, 0x64, 0x12, 0x2f, 0x0a, 0x05, 0x64, 0x69, 0x73, 0x6b, 0x73, 0x18, 0x02,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x64, 0x65, 0x70, 0x6f, 0x74, 0x2e, 0x63, 0x6c, 0x6f,
	0x75, 0x64, 0x2e, 0x76, 0x33, 0x2e, 0x44, 0x69, 0x73, 0x6b, 0x53, 0x70, 0x61, 0x63, 0x65, 0x52,
	0x05, 0x64, 0x69, 0x73, 0x6b, 0x73, 0x22, 0xaf, 0x01, 0x0a, 0x09, 0x44, 0x69, 0x73, 0x6b, 0x53,
	0x70, 0x61, 0x63, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x18, 0x01,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_machine_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_machine_proto_goTypes = []interface{}{
	...
	(*ReportChangeLogsRequest)(nil),                   // 16: depot.cloud.v3.ReportChangeLogsRequest
	(*ImageChangeLogs)(nil),                           // 17: depot.cloud.v3.ImageChangeLogs
	(*Changelog)(nil),                                 // 18: depot.cloud.v3.Changelog
	(*ReportChangeLogsResponse)(nil),                  // 19: depot.cloud.v3.ReportChangeLogsResponse
	(*RegisterMachineRequest_AWSRegistration)(nil),    // 20: depot.cloud.v3.RegisterMachineRequest.AWSRegistration
	(*RegisterMachineResponse_Mount)(nil),             // 21: depot.cloud.v3.RegisterMachineResponse.Mount
	(*RegisterMachineResponse_PendingTask)(nil),       // 22: depot.cloud.v3.RegisterMachineResponse.PendingTask
	(*RegisterMachineResponse_BuildKitTask)(nil),      // 23: depot.cloud.v3.RegisterMachineResponse.BuildKitTask
	(*RegisterMachineResponse_Profiler)(nil),          // 24: depot.cloud.v3.RegisterMachineResponse.Profiler
	(*RegisterMachineResponse_Mount_CephVolume)(nil),  // 25: depot.cloud.v3.RegisterMachineResponse.Mount.CephVolume
	nil,                            // 26: depot.cloud.v3.ReportStatusRequest.StableDigestsEntry
	(*control.StatusResponse)(nil), // 27: moby.buildkit.v1.StatusResponse
}
var file_machine_proto_depIdxs = []int32{
	20, // 0: depot.cloud.v3.RegisterMachineRequest.aws:type_name -> depot.cloud.v3.RegisterMachineRequest.AWSRegistration
	22, // 1: depot.cloud.v3.RegisterMachineResponse.pending:type_name -> depot.cloud.v3.RegisterMachineResponse.PendingTask
	23, // 2: depot.cloud.v3.RegisterMachineResponse.buildkit:type_name -> depot.cloud.v3.RegisterMachineResponse.BuildKitTask
	...
	27, // 5: depot.cloud.v3.ReportStatusRequest.status:type_name -> moby.buildkit.v1.StatusResponse
	26, // 6: depot.cloud.v3.ReportStatusRequest.stable_digests:type_name -> depot.cloud.v3.ReportStatusRequest.StableDigestsEntry
	...
	17, // 9: depot.cloud.v3.ReportChangeLogsRequest.images:type_name -> depot.cloud.v3.ImageChangeLogs
	18, // 10: depot.cloud.v3.ImageChangeLogs.layer_changelogs:type_name -> depot.cloud.v3.Changelog
	...
	25, // 12: depot.cloud.v3.RegisterMachineResponse.Mount.ceph_volume:type_name -> depot.cloud.v3.RegisterMachineResponse.Mount.CephVolume
	6,  // 13: depot.cloud.v3.RegisterMachineResponse.BuildKitTask.cert:type_name -> depot.cloud.v3.Cert
	6,  // 14: depot.cloud.v3.RegisterMachineResponse.BuildKitTask.ca_cert:type_name -> depot.cloud.v3.Cert
	21, // 15: depot.cloud.v3.RegisterMachineResponse.BuildKitTask.mounts:type_name -> depot.cloud.v3.RegisterMachineResponse.Mount
	24, // 16: depot.cloud.v3.RegisterMachineResponse.BuildKitTask.profiler:type_name -> depot.cloud.v3.RegisterMachineResponse.Profiler
	1,  // 17: depot.cloud.v3.MachineService.RegisterMachine:input_type -> depot.cloud.v3.RegisterMachineRequest
	3,  // 18: depot.cloud.v3.MachineService.PingMachineHealth:input_type -> depot.cloud.v3.PingMachineHealthRequest
	7,  // 19: depot.cloud.v3.MachineService.Usage:input_type -> depot.cloud.v3.UsageRequest
	10, // 20: depot.cloud.v3.MachineService.ReportStatus:input_type -> depot.cloud.v3.ReportStatusRequest
	12, // 21: depot.cloud.v3.MachineService.ReportSBOM:input_type -> depot.cloud.v3.ReportSBOMRequest
	16, // 22: depot.cloud.v3.MachineService.ReportChangeLogs:input_type -> depot.cloud.v3.ReportChangeLogsRequest
	2,  // 23: depot.cloud.v3.MachineService.RegisterMachine:output_type -> depot.cloud.v3.RegisterMachineResponse
	5,  // 24: depot.cloud.v3.MachineService.PingMachineHealth:output_type -> depot.cloud.v3.PingMachineHealthResponse
	9,  // 25: depot.cloud.v3.MachineService.Usage:output_type -> depot.cloud.v3.UsageResponse
	11, // 26: depot.cloud.v3.MachineService.ReportStatus:output_type -> depot.cloud.v3.ReportStatusResponse
	15, // 27: depot.cloud.v3.MachineService.ReportSBOM:output_type -> depot.cloud.v3.ReportSBOMResponse
	19, // 28: depot.cloud.v3.MachineService.ReportChangeLogs:output_type -> depot.cloud.v3.ReportChangeLogsResponse
...
func file_machine_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_machine_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReportChangeLogsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_machine_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReportChangeLogsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_machine_proto_msgTypes[20].OneofWrappers = []interface{}{}
	file_machine_proto_msgTypes[22].OneofWrappers = []interface{}{}
	type x struct{}
